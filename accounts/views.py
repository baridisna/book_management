...
def RolesView(request):
    return render(request=request, template_name="roles.html", context={"test": "test"})
...
def UsersAddView(request):
    ...
    user = request.user
    return render(request=request, template_name="users-add.html", 
...
def UsersEditView(request, id):
    ...
    user = request.user
    return render(request=request, template_name="users-edit.html",
